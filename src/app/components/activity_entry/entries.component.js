...
var EntriesComponent = (function () {
    function EntriesComponent(_router, _api, _auth, _title, _logger, _loading, _err, _popup) {
    ...
    EntriesComponent.prototype.routerOnActivate = function (e) {
    ...
    EntriesComponent.prototype.routerOnDeactivate = function (e) {
